# Theia SDK - Unity 6.3 LTS Samples

Sample scenes and scripts for the Theia SDK (formerly HarmonEyes SDK) targeting Unity 6.3 LTS.
...
**Import URL:**
```
https://github.com/RandyHaylor/theia-sdk-unity6-3-lts-samples.git?path=/EyeTrackingCommon
```
...
2. Paste: `https://github.com/RandyHaylor/theia-sdk-unity6-3-lts-samples.git?path=/EyeTrackingCommon`
3. Click "Add"
